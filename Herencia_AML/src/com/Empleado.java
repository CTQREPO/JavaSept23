...
public class Empleado extends Persona implements IArquitectura, IMedicina, IMarketing{
	...
	public Empleado(String nombre, Date fechaNac, double estatura, String sexo, double salario, int numEpleado,
			String nss) {
	...
	public String toString() {
		return "Empleado [salario=" + salario + ", numEpleado=" + numEpleado + ", nss=" + nss + ", nombre=" + nombre
	...
	@Override //Sobreescritura por mandato
	public void caminar() {
	...
	@Override //Sobreescritura de la forma 3 (Métodos implementados)
	public void diseñar() {
